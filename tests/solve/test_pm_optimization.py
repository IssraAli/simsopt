...
class Testing(unittest.TestCase):
    ...
    def test_algorithms(self):
        ...
        with ScratchDir("."):
            ...
            kwargs["max_iter_RS"] = (
                20  # Number of total iterations of the relax-and-split algorithm
            )
            ...
            kwargs["nhistory"] = 10
            kwargs["K"] = 10
            errors1, Bn_errors1, m_history1 = GPMO(
                pm_opt, algorithm="baseline", **kwargs
            )
            m1 = pm_opt.m
            ...
            pol_vector_z[:, 2] = 1.0
            pol_vectors = np.transpose(
                np.array([pol_vector_x, pol_vector_y, pol_vector_z]), [1, 0, 2]
            )
            ...
            errors4, Bn_errors4, m_history4 = GPMO(
                pm_opt, algorithm="backtracking", **kwargs
            )
            m4 = pm_opt.m
            ...
            errors5, Bn_errors5, m_history5 = GPMO(
                pm_opt, algorithm="ArbVec_backtracking", **kwargs
            )
            m5 = pm_opt.m
            ...
            with self.assertRaises(NotImplementedError):
                errors5, Bn_errors5, m_history5 = GPMO(
                    pm_opt, algorithm="random_name", **kwargs
                )

            kwargs["m_init"] = pm_opt.m.reshape([-1, 3])
            pm_opt.coordinate_flag = "cartesian"
            errors6, Bn_errors6, m_history6 = GPMO(
                pm_opt, algorithm="ArbVec_backtracking", **kwargs
            )
