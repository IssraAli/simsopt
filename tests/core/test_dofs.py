...
class DOFsTests(unittest.TestCase):
    ...
    def test_lower_bounds(self):
        ...
        self.assertTrue(
            np.allclose(dofs.free_lower_bounds, np.array([-np.inf, -np.inf]))
        )
        ...
        self.assertTrue(
            np.allclose(dofs.free_lower_bounds, np.array([-1000.0, -1001.0]))
        )

        dofs.unfix_all()
        self.assertTrue(
            np.allclose(dofs.free_lower_bounds, np.array([-1000.0, -1001.0, -np.inf]))
        )

        dofs.free_lower_bounds = np.array([-1000.0, -1001.0, -1002.0])
        self.assertTrue(
            np.allclose(dofs.free_lower_bounds, np.array([-1000.0, -1001.0, -1002.0]))
        )
    ...
    def test_upper_bounds(self):
        ...
        self.assertTrue(np.allclose(dofs.free_upper_bounds, np.array([np.inf, np.inf])))
        ...
        self.assertTrue(np.allclose(dofs.free_upper_bounds, np.array([1000.0, 1001.0])))

        dofs.unfix_all()
        self.assertTrue(
            np.allclose(dofs.free_upper_bounds, np.array([1000.0, 1001.0, np.inf]))
        )

        dofs.free_upper_bounds = np.array([1000.0, 1001.0, 1002.0])
        self.assertTrue(
            np.allclose(dofs.free_upper_bounds, np.array([1000.0, 1001.0, 1002.0]))
        )
    ...
    def test_bounds(self):
        ...
        bounds = dofs.bounds
        self.assertTrue(
            np.allclose(bounds[0], np.array([-100.0, -101.0]))
            and np.allclose(bounds[1], np.array([100.0, 101.0]))
        )
    ...
    def test_update_upper_bound(self):
        ...
        self.assertTrue(np.allclose(dofs.free_upper_bounds, np.array([200.0, 101.0])))
    ...
    def test_update_lower_bound(self):
        ...
        self.assertTrue(np.allclose(dofs.free_lower_bounds, np.array([-200.0, -101.0])))
        # Test with integer keys
