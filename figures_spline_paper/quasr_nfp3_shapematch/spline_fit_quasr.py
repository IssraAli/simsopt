...
TARGET_FILE = (
    "/Users/issraali/codes/simsopt/figures_spline_paper/quasr_nfp3_shapematch/input.1942772"
)
...
def plot_cross_section_comparison(target_surf, spline_surf, title, n_cuts=8):
    """
...
target_surf = SurfaceRZFourier.from_vmec_input(TARGET_FILE)
