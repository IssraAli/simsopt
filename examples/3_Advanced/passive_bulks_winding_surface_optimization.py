#!/usr/bin/env python
r"""
Coupled optimization of TF coils with passive bulk pucks on a **winding surface**
...
from simsopt.field.puck_init import winding_surface_pucks
...
OUT_DIR = os.path.join(
    ...
    "passive_bulks_winding_surface_optimization_out",
)
...
# ---------------------------------------------------------------------------
# 3. Passive bulk pucks on a winding surface (normal offset from plasma); all puck
